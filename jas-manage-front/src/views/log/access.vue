  ...
  <div class="container-wrap">
    <div class="container-box">
      ...
      <!--<div class="search-box">-->
        <!--<el-input placeholder="请输入用户名" icon="search" v-model="key_word" :on-icon-click="handleIconClick">-->
        <!--</el-input>-->
      <!--</div>-->

      <!--<div class="search-box">-->
        <!--<el-input placeholder="请输入ip地址" icon="search" v-model="key_word1" :on-icon-click="handleIconClick1">-->
        <!--</el-input>-->
      <!--</div>-->
      <div class="container-content">
        ...
        <div class="block">
          ...
          <el-input placeholder="请输入用户名" icon="search" v-model="key_word" :on-icon-click="handleIconClick" style="width: 400px">
          </el-input>
          <el-input placeholder="请输入ip地址" icon="search" v-model="key_word1" :on-icon-click="handleIconClick1" style="width: 400px">
          </el-input>
        </div>
